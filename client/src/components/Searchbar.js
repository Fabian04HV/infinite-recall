...
export const Searchbar = ({hidden}) => {
  ...
  return(
  <>
    <div className={`search-bar ${hidden && 'hidden'}`}>
        ...
        <input onChange={searchHandler} onKeyDown={searchHandler} value={searchTerm} type='search' id='search-input' className='search-input' placeholder='Search Flashcard Collections about anything!' autoComplete="off"/>
