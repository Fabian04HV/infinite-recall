...
export const Searchbar = ({hidden}) => {
  ...
  <>
    <div className={`search-bar ${hidden && 'hidden'}`}>
        ...
        <input onChange={searchHandler} onKeyDown={searchHandler} type='search' id='search-input' className='search-input' placeholder='Search Flashcard Collections about anything!' autoComplete="off"/>
